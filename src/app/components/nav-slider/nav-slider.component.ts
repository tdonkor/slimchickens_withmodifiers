...
import { onAdaUpdate } from '../../helpers/ada.helper';
@Component({
...
export class NavSliderComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    public evaluateDisable() {
        ...
        this.disableRightArrow =
            this.scrollRef?.nativeElement.scrollLeft + this.scrollRef?.nativeElement.clientWidth ===
            this.scrollRef?.nativeElement.scrollWidth;
    ...
    private updateInfiniteScroll(): void {
      ...
      const buttonWidth = this.scrollRef.nativeElement.children && this.scrollRef.nativeElement.children.length ? this.scrollRef.nativeElement.children[0].clientWidth : (this.buttonSize || 0);

...
import { DotButton, calculateButtonPrice, DotButtonType } from 'dotsdk';
...
export class ButtonModifierComponent implements OnInit, OnDestroy {
  ...
  public get showButtonCounterEdit(): boolean {
    ...
    return this.maxQuantity > 1 || this.hasPrefixes || !this.maxQuantityExists || this.basketExceededMaxQty || this.isBasketButtonWithoutMaxQty;
  }
  ...
  public get defaultQuantityLabel() {
    ...
    if (this.modifierButton.DefaultQuantity < this.modifierButton.quantity) {
      return this.calculatePrice > 0 ? `${this.quantityAdded} ${this.translatePipe.transform('2021050702')} ${this.translatePipe.transform('2021051001')}` :
  ...
  public get hasDefaultQuantity(): boolean {
    return this.modifierButton.DefaultQuantity && this.modifierButton.DefaultQuantity > 0 && this.modifierButton.DefaultQuantity <= this.modifierButton.MaxQuantity;
  }
  ...
  public ngOnInit(): void {
    ...
    this.modifierButton.quantity = (this.modifierButton.MinQuantity > 0 && this.modifierButton.quantity < this.modifierButton.MinQuantity) ? this.modifierButton.MinQuantity : this.modifierButton.quantity;
  ...
  public increaseQuantityWithDefaultQty() {
    if (this.modifierButton.quantity === 0) {
      ...
      this.modifierButton.Selected = true;
    } else if (this.modifierButton.quantity > 0 && this.getQuantityButtons < this.maxQuantityGroup && this.modifierButton.quantity < this.modifierButton.MaxQuantity) {
      this.modifierButton.Selected = true;
      this.modifierButton.quantity++;
    }
  ...
  public selectedDefaultQuantity() {
    if (this.hasDefaultQuantity && (this.modifierButton.quantity === null || this.modifierButton.quantity === undefined) && this.modifierButton.MinQuantity <= this.modifierButton.DefaultQuantity) {
      this.modifierButton.Selected = true;
      this.modifierButton.quantity = this.modifierButton.DefaultQuantity;
    }
  }
  ...
  private setRemoveModifier() {
    this.modifierButton.removeItem = !!(this.modifierButton.DefaultQuantity &&

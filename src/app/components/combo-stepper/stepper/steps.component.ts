...
export class StepsComponent implements OnInit, OnChanges {
  @Input() public steps: DotCombo[] | DotPage[] | any[] = [];
  @Input() public activeIndex = 0;

  public localSteps: DotCombo[] | DotPage[] | any[];
  ...
  public getStepNumber(index: number) {
    return this.steps.indexOf(this.localSteps[index]) + 1;
  }

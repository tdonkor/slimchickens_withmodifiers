import { AtpApplicationSettings, PosServingLocation } from 'dotsdk';
...
import { RoundingStrategies } from '../enums/rounding-strategies.enum';
...
export class ApplicationSettingsService {
  ...
  public paymentCheckMode: DeviceCheckMode = DeviceCheckMode.DoNotTest;
  public printerCheckMode: DeviceCheckMode = DeviceCheckMode.DoNotTest;
  public scannerCheckMode: DeviceCheckMode = DeviceCheckMode.DoNotTest;
  public POSCheckMode: DeviceCheckMode = DeviceCheckMode.DoNotTest;
  ...
  private setBundleArray(displayName: string): Array<any> {
    return this.appSettings.bundleSettingsJson[displayName]
